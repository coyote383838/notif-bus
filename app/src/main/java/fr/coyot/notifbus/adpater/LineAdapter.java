...
public class LineAdapter extends BaseAdapter {
	...
	public LineAdapter(List<Line> myLineList, Context myContext) {
		super();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			layoutItem = (LinearLayout) myInflater.inflate(R.layout.list_layout_lines, parent, false);
		} else {
		...
		TextView element = (TextView) layoutItem.findViewById(R.id.Element_Id);
		if (myLineList == null){
			Log.d("LineAdapter - GetView", "myLineList is null");
		} else if (myLineList.get(position) == null){
			Log.d("LineAdapter - GetView", "myLineList.get(position) is null");
		} else if (element == null) {
			Log.d("LineAdapter - GetView", "element is null");
		}
